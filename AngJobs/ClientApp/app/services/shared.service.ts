...
export class SharedService {
    ...
    public GetJobs(): Promise<JobDetail[]>
    {
        return this.http.get('/api/SampleData/GetJobs')
            .map((res: Response) => res.json() as JobDetail[])
            .toPromise()
    ...
    public GetJobDetail(id: number): Promise<JobDetail>
    {
