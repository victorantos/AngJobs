app.directive('jobLine', function () {
    ...
    var endFirstLinkIndex = $scope.jobTitle.indexOf('</a>');

    //make sure the link has also the ending tag
    if (firstLinkIndex > -1 && endFirstLinkIndex > -1 && endFirstLinkIndex > firstLinkIndex) {
