...
date: 2026-06-01
description: Fusionbox - Python + TypeScript Engineers - United States - Full-time - REMOTE (US) We're a software engineering consultancy that builds enterprise…
author: subleq
authorUrl: https://news.ycombinator.com/item?id=48359593
byline: subleq
section: june-2026
tags:
  - june-2026
...
Fusionbox - Python + TypeScript Engineers - United States - Full-time - REMOTE (US)
...
A note on how we work: we think deeply about the systems we build, and we believe understanding comes from doing the work yourself, not from handing it to a model. If you ship code you don&#x27;t understand, we&#x27;re genuinely not a fit, and that&#x27;s fine. If that paragraph made you nod, we want to hear from you.
